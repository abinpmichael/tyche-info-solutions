        ...
        <div class="card-body">
            ...
            <form action="<?= base_url('services-admin/store') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control rich-editor" name="desc1" rows="5" required><?= old('desc1') ?></textarea>
                </div>

                <div class="mb-3">
                    <label class="form-label font-weight-bold">Description Paragraph 2</label>
                    <textarea class="form-control rich-editor" name="desc2" rows="5"><?= old('desc2') ?></textarea>
                </div>
