...
<h2></h2>
<form action="<?= base_url('slider/store'); ?>" method="post">
    <label>Big Heading</label>
     <?= csrf_field(); ?>
    <input type="text" name="b_heading" class="form-control" required>
    <label>Small Heading</label>
    <input type="text" name="s_heading" class="form-control" required>
    <label>Button Name</label>
    <input type="text" name="button_name" class="form-control" required>
    <label>Button Link</label>
    <input type="text" name="b_link" class="form-control" required>
    <label>Image</label>
