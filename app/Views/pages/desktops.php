        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-3 col-lg-4 d-none d-lg-block mb-6 mb-lg-0 pr-xl-5">
                <div class="card border-0 bg-light p-4 shadow-sm rounded-lg">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="mb-2">
                            <a href="<?= base_url('desktops') ?>" class="d-flex justify-content-between align-items-center py-1 <?= empty($selectedBrand) ? 'font-weight-bold text-primary' : 'text-gray-90' ?>">
                        ...
                        <?php foreach ($brands as $brand): ?>
                            ...
                            ?>
                            <li class="mb-2">
                                <a href="<?= base_url('desktops?brand=' . $brand['b_id']) ?>" class="d-flex justify-content-between align-items-center py-1 <?= ($selectedBrand == $brand['b_id']) ? 'font-weight-bold text-primary' : 'text-gray-90' ?>">
            ...
            <div class="col-xl-9 col-lg-8 col-md-12">
                ...
                <div class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-4">
                    <h2 class="font-size-22 font-weight-bold mb-0 text-dark">Desktop Rental & Refurbished Systems</h2>
                    <span class="text-muted font-size-14"><?= count($desktops) ?> product(s) found</span>
                </div>
                <!-- End Shop Header -->
                ...
                <div class="row no-gutters products-group">
                                ...
                                <div class="product-item__outer h-100 w-100 d-flex flex-column justify-content-between">
                                    <div class="product-item__inner">
                                        ...
                                        <div class="product-info mb-3">
                                            <h6 class="font-size-12 text-gray-5 mb-1">Desktop</h6>
                    ...
                    <?php else: ?>
                        <div class="col-12 p-8 text-center text-muted">
                            <i class="fas fa-desktop font-size-50 mb-3 text-light"></i>
