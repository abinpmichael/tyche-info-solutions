    ...
    <div class="container">
        <div class="text-center">
            <div class="card-body subhead-60 pb-6 px-0 continer-head">
                <?php
                $termsTitleTag = esc($terms['terms_title_tag'] ?? 'h4');
                $termsTitleText = esc($terms['terms_title'] ?? 'Terms and conditions');
                $termsSubtitleTag = esc($terms['terms_subtitle_tag'] ?? 'h5');
                $termsSubtitleText = esc($terms['terms_subtitle'] ?? $terms['intro'] ?? 'By using our website and services, you agree to the following terms and conditions.');
                ?>
                <<?= $termsTitleTag ?>><?= $termsTitleText ?></<?= $termsTitleTag ?>>
                <div class="border-bottom">
                    <div class="list-group list-group-horizontal flex-wrap list-group-borderless align-items-center mx-n0dot5">
                        <<?= $termsSubtitleTag ?>><?= $termsSubtitleText ?></<?= $termsSubtitleTag ?>>
                    </div>
                </div>                    
            </div>
        </div>
        ...
        <div class="mb-5">
            <h3 class="mb-2 pb-2 font-size-25"><?= esc($terms['rental_title'] ?? 'Rental Services Terms') ?></h3>
            ...
            <h3 class="mb-2 pb-2 font-size-25"><?= esc($terms['refurbished_title'] ?? 'Refurbished Products Terms') ?></h3>
        ...
        <div class="mb-5">
            <h3 class="mb-2 pb-2 font-size-25"><?= esc($terms['payments_title'] ?? 'Payments and Charges') ?></h3>
        ...
        <div class="mb-5">
            <h3 class="mb-2 pb-2 font-size-25"><?= esc($terms['delivery_title'] ?? 'Delivery and Collection') ?></h3>
        ...
        <div class="mb-5">
            <h3 class="mb-2 pb-2 font-size-25"><?= esc($terms['liability_title'] ?? 'Limitation of Liability') ?></h3>
        ...
        <div class="mb-5">
            <h3 class="mb-2 pb-2 font-size-25"><?= esc($terms['privacy_title_sec'] ?? 'Privacy') ?></h3>
