        ...
        <footer >
          ...
          <div class="pt-8 pb-4 bg-gray-13 bg-primary-down-lg footer" style="background: linear-gradient(90deg, rgba(3,70,239,1) 0%, rgba(4,147,241,1) 50%);">
                ...
                <div class="container mt-1">
                    <div class="row">
                            ...
                            <div class="my-4 my-md-4">
								...
								<div class="col-xl-4 col-lg-4 col-md-6 cols-m-6 col-xs-12 col-12  mb-3 mb-md-0">
                                    <h6 class="mb-3 font-weight-bold">Contact info</h6>
									   <div class="row no-gutters">
                                    <div class="col-auto">
                                        <i class="ec ec-map-pointer text-primary font-size-56" style="color: #fff !important;"></i>
                                    </div>
                                    <address class="">
                                       G-54, 1st Cross Road,<br>
                                       Panampilly Nagar, Kochi - 682036<br>
                                       GSTIN: 32ABECS7461B1ZM
                                     </address> 
                                     </div>
									   <div class="row no-gutters">
                                    
                                    <div class="col-auto">
                                        <i class="ec ec-support text-primary font-size-56" style="color: #fff !important;"></i>
                                    </div>
                                    <div class="col">
                                        <div class="font-size-13 font-weight-light">Got questions? Call us / Mail</div>
                                        <a href="tel:+919946622288" class="font-size-16 text-white-90">+91 9946622288</a><br>
                                        <a href="tel:+919946722288" class="font-size-16 text-white-90">+91 9946722288</a><br>
                                        <a class="font-size-16 text-white-90" href="mailto:sales@tycheinfosolutions.com">sales@tycheinfosolutions.com</a>
                                    </div>
                                </div>
									<br>   
            ...
            <div class="bg-gray-14 py-2">
                <div class="container">
                    <div class="flex-center-between d-block d-md-flex">
                        <div class="mb-3 mb-md-0">© 2025 Tyche Info Solutions | All rights reserved | Developed by  <a href="http://www.magiccodz.com/" target="_blank" style="COLOR: #0453f1;">Magic Codz Software Solutions</a></div>
                    </div>
                </div>
            </div>
                                ...
                                <form class="js-validate">
                                    ...
                                    <div id="login" data-target-group="idForm">
                                        ...
                                        <div class="d-flex justify-content-end mb-4">
                                            <a class="js-animation-link small link-muted" href="javascript:;"0
