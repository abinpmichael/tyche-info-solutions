...
<html lang="en">
    <head>
        ...
        <title>Tyche Info Solutions | Assembled Desktop Details</title>
        <meta name="description" content="">
        <meta name="keywords" content="">
        <meta name="author" content="Tyche Info Solutions">
        <meta name="robots" content="ALL">
        <meta name="geo.country" content="IN">
        <meta name="DC.title" content="Tyche Info Solutions | Assembled Desktop Details">
        <meta name="geo.region" content="">
        <meta name="geo.placename" content="Kochi">
        <meta name="geo.position" content=" ">
        <meta property="og:title" content="Tyche Info Solutions | Assembled Desktop Details">
        <meta property="og:site_name" content="Tyche Info Solutions">
        <meta property="og:url" content="intel-i5-12th-gen.php">
        <meta property="og:description" content="">
        <meta property="og:type" content="website">
        <meta property="og:image" content="">
	    <meta name="ICBM" content="">
	    <meta name="msvalidate.01" content="">		
        <link rel="canonical" href="intel-i5-12th-gen.php"> 
        <!-- Favicon -->
                    ...
                    <!-- breadcrumb -->
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                                ...
                                <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page">Intel i5 12th Gen</li>
                            </ol>
                        </nav>
                    <!-- End breadcrumb -->
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-5 col-lg-5 col-md-12 col-12 mb-4 mb-md-0">
                            <div id="sliderSyncingNav" class="js-slick-carousel u-slick mb-2"
                                ...
                                <div class="js-slide">
                                    <img class="img-fluid" src="assets/img/laptops/assembeled-desktop-2.jpg" width="100%" alt="Image Description">
                                </div>
                                <div class="js-slide">
                                    <img class="img-fluid" src="assets/img/laptops/assembeled-desktop-2.jpg" width="100%"  alt="Image Description">
                                </div>
                            ...
                            <div id="sliderSyncingThumb" class="js-slick-carousel u-slick u-slick--slider-syncing u-slick--slider-syncing-size u-slick--gutters-1 u-slick--transform-off"
                                ...
                                <div class="js-slide" style="cursor: pointer;">
                                    <img class="img-fluid" src="assets/img/laptops/assembeled-desktop-2.jpg" alt="Image Description">
                                </div>
                                <div class="js-slide" style="cursor: pointer;">
                                    <img class="img-fluid" src="assets/img/laptops/assembeled-desktop-2.jpg" alt="Image Description">
                                </div>
                        ...
                        <div class="col-xl-7 col-lg-7 col-md-12 col-12 mb-md-6 mb-lg-0">
                            <div class="mb-6">
                                <div class="border-bottom mb-3 pb-md-1 pb-3 product-det">
                                    <h2 class="font-size-25 text-lh-1dot2">Intel i5 12th Gen <br>
                                    <span> (16 GB / 2 HDMI / 2 USB / LAN) </span></h2>
                                </div>
